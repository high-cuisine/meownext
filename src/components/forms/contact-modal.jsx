...
export default function ContactModal({ open, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-[90] flex items-stretch justify-center md:items-center md:p-6" role="dialog" aria-modal="true" aria-label="Начнём работу?">
      ...
      <div
        className="modal-card-anim relative z-10 flex h-full w-full flex-col overflow-y-auto overflow-x-hidden bg-[#1F1F1F] px-3 py-6 md:h-auto md:max-h-[90vh] md:w-auto md:max-w-[777px] md:rounded-[32px] md:px-8 md:py-8 md:shadow-[0_24px_80px_rgba(0,0,0,0.5)]"
      ...
      >
        <button
          ...
          aria-label="Закрыть"
          onClick={onClose}
          className="absolute right-3 top-6 z-20 flex size-12 items-center justify-center text-[#a5a5a5] transition-[color,transform] hover:text-[#fdfdfd] active:text-[#d4d4d4] active:scale-90 md:right-6 md:top-6"
        >
        ...
        <div className="relative z-10 mx-auto w-full max-w-[713px]">
