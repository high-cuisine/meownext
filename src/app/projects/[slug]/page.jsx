  ...
  return (
    <>
      ...
      <section className="pb-12 pt-8">
        <PageContainer className="flex flex-col gap-3 md:gap-5">
          <div
            data-reveal
            className="relative aspect-394/286 w-full overflow-hidden rounded-4xl md:aspect-1312/569"
          >
            <Image
              src={HeroImg}
              alt={project.title}
          ...
          <div className="grid grid-cols-2 gap-3">
            <a
              ...
              data-reveal
              className="btn-press group flex h-14 items-center justify-center rounded-[20px] bg-[#141414] hover:bg-[#333333] active:bg-[#292929] md:h-20 md:rounded-[32px]"
            >
      ...
      <section className="py-10 md:py-16">
        <div data-reveal className="relative w-full">
          <Image
            src={WideImg}
            alt={`Дизайн проекта ${project.title}`}
            className="aspect-4/3 h-auto w-full object-cover"
            sizes="100vw"
          />
        </div>
      ...
      <section className="py-10 md:py-16">
        <div data-reveal className="relative w-full">
          <Image
            src={FinalImg}
            alt={`Макет проекта ${project.title}`}
            className="aspect-4/3 h-auto w-full object-cover"
            sizes="100vw"
          />
        </div>
